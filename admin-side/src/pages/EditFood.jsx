...
import { fetchFromCategory, fetchFromDetailFood } from "../action/actionCreator";
      ...
      <div className="flex flex-col justify-center min-py-12 mt-[-60px] sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="px-4 py-8 sm:px-10">
            <form
              onSubmit={handleSubmit(editFood)}
              className="space-y-6"
              action="#"
              method="POST"
            >
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    type="text"
                    defaultValue={food.data?.description}
                    className="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"
                  />
                </div>
              </div>
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    type="text"
                    defaultValue={food.data?.Ingredients[0]?.name}
                    noValidate
                    className="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"
                  />
                </div>
                <div className="mt-1">
                  <input
                    ...
                    type="text"
                    noValidate
                    defaultValue={food.data?.Ingredients[1]?.name}
                    className="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"
                  />
                </div>
                <div className="mt-1">
                  <input
                    ...
                    type="text"
                    noValidate
                    defaultValue={food.data?.Ingredients[2]?.name}
                    className="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"
                  />
                </div>
              </div>
